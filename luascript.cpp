...
template<>
void Script::RegisterFieldGlobal<int>(int value, std::string text)
{
    lua_pushinteger(lua_state, value);
...
template<>
void Script::RegisterFieldGlobal<double>(double value, std::string text)
{
    lua_pushnumber(lua_state, value);
    lua_setfield(lua_state, -2, text.data());
}
...
template<>
void Script::RegisterFieldGlobal<char*>(char* value, std::string text)
{
    lua_pushstring(lua_state, value);
    lua_setfield(lua_state, -2, text.data());
}
...
template<>
void Script::RegisterFieldGlobal<bool>(bool value, std::string text)
{
    lua_pushboolean(lua_state, value);
    lua_setfield(lua_state, -2, text.data());
}
...
template<>
void Script::RegisterFieldGlobal<lua_CFunction>(lua_CFunction value, std::string text)
{
    lua_pushcfunction(lua_state, value);
    lua_setfield(lua_state, -2, text.data());
}
